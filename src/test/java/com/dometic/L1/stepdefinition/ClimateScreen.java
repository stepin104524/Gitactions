...
public class ClimateScreen extends Baseclass {
    ...
    public static String maxTemp, minTemp, minTempHeater, maxTempHeater, fanspeed, getHighlightedText, getHighlightedFanSpeed, getHighlightedhotWaterLevelValue, getHighlightedEnergyValue;
...
//        driver.pressKeyCode(AndroidKeyCode.BACK);
    ...
    public void iTapOnACFanSpeedInClimateScreen() throws Throwable {
        ...
        getHighlightedFanSpeed = driver.findElementByAccessibilityId(Constant_climate_ac.CAC_fanspeed_value_access_id).getText();
...
//        }
    ...
    public void iTapOnAcModeInClimateScreen() throws Throwable {
        ...
        TaponbuttonaccessabilityID(Constant_climate_ac.CAC_M_climate_acModeContainer_access_id);
        getHighlightedText = driver.findElementByAccessibilityId(Constant_climate_ac.CAC_M_AC_Mode_Value_access_id).getText();
    }
...
//        Assert.assertTrue(iselementdisplayedaccessabilityId(Constant_climate_ac.CAC_AM_Outside_Units_access_id));
    ...
    public void iVerifyApplyButtonIsDisplayedInACClimateScreen() throws Throwable {
        ...
        acMode.add(driver.findElement(By.xpath(Constant_climate_ac.CAC_AC_first_value_xpath)).getText());
        acMode.add(driver.findElement(By.xpath(Constant_climate_ac.CAC_AC_second_value_xpath)).getText());
    ...
    public void iVerifyApplyButtonIdDisplayedInACFanSpeedInAcClimateScreen() throws Throwable {
        ...
        fanSpeed.add(driver.findElement(By.xpath(Constant_climate_ac.CAC_FAN_first_value_xpath)).getText());
        fanSpeed.add(driver.findElement(By.xpath(Constant_climate_ac.CAC_FAN_second_value_xpath)).getText());
...
//        Assert.assertTrue(iselementdisplayedaccessabilityId(Constant_climate_heater.CHeater_M_outside_units_access_id));
    ...
    public void iTapOnHotWaterLevelInHeaterClimateScreen() throws Throwable {
        ...
        getHighlightedhotWaterLevelValue = driver.findElementByAccessibilityId(Constant_climate_heater.CHeater_M_hot_water_Level_mode_access_id).getText();
    }
...
//        Assert.assertTrue(iselementdisplayedaccessabilityId(Constant_climate_heater.CHeater_HWL_outside_units_access_id));
    ...
    public void iVerifyApplyButtonIsDisplayedInHotWaterLevelHeaterClimateScreen() throws Throwable {
        ...
        hotWaterLevel.add(driver.findElement(By.xpath(Constant_climate_heater.CHeater_WaterHeater_first_value_xpath)).getText());
        hotWaterLevel.add(driver.findElement(By.xpath(Constant_climate_heater.CHeater_WaterHeater_second_value_xpath)).getText());
    ...
    public void iTapOnEnergyInHeaterClimateScreen() throws Throwable {
        ...
        getHighlightedEnergyValue = driver.findElementByAccessibilityId(Constant_climate_heater.CHeater_M_energy_value_access_id).getText();
    }
...
//            Assert.assertTrue(iselementdisplayedaccessabilityId(Constant_climate_heater.CHeater_Energy_outside_units_access_id));
    ...
    public void iVerifyApplyButtonIsDisplayedInEnergyInHeaterClimateScreen() throws Throwable {
        ...
        energy.add(driver.findElement(By.xpath(Constant_climate_heater.CHeater_EnergyHeater_first_value_xpath)).getText());
        energy.add(driver.findElement(By.xpath(Constant_climate_heater.CHeater_EnergyHeater_second_value_xpath)).getText());
...
//        TaponbuttonaccessabilityID(Constant_climate_ac.CAC_AM_Apply_Button_access_id);
    ...
    public void iScrollMinimumTemperatureInClimateHeater() throws Throwable {
        ...
        try {
            ...
            while (list.size() != 0) {
                ...
                action.press(PointOption.point(550, 600)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1)))
                ...
                if (driver.findElement(By.xpath(Constant_climate_heater.CHeater_common_temperature_xpath)).getText().equals("5")) {
                    ...
                    action1.press(PointOption.point(550, 600)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1)))
                            .moveTo(PointOption.point(900, 600));
        ...
        try {
            ...
            while (list.size() != 0) {
                ...
                action.press(PointOption.point(900, 600)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1)))
                        .moveTo(PointOption.point(550, 600));
                action.release().perform();
    ...
    public void iTapOnHeaterPower() throws Throwable {
        ...
        String text = driver.findElementByAccessibilityId(Constant_climate_heater.CHeater_M_power_button_access_id).getAttribute("text");
