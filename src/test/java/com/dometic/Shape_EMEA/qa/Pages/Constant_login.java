...
public class Constant_login extends Baseclass {
        ...
        public static final String ValidUser = "sdbtest22@yopmail.com";
        public static final String Validpassword = "Dom@1234";
        public static final String new_user_email = "shapeemeaprod@gmail.com";
        public static final String new_user_password = "Dom@1234";
        public static final String invaliduser1 = "dsasdddfd";
        ...
        public static final String Login_welcome_text_Xpath_OR_Operator = "//android.widget.TextView[contains(@text,'Welcome!') or @content-desc='com.dometicapp:id/login-welcomeText']";
        public static final String Login_login_text_Xpath_OR_Operator= "//android.widget.TextView[contains(@text,'Log In') or @content-desc='com.dometicapp:id/login-loginText']";
        public static final String Login_email_text_Xpath_OR_Operator = "//android.widget.TextView[contains(@text,'E-mail') or @content-desc='.dometicapp:id/login-email-textLabel']";
        public static final String Login_email_field_access_id= "com.dometicapp:id/login-emailTextfield";
        public static final String Login_password_text_Xpath_OR_Operator = "//android.widget.TextView[contains(@text,'Password') or @content-desc='com.dometicapp:id/login-password-textLabel']";
        ...
        public static final String Login_signup_link_Xpath_OR_Operator="//android.widget.TextView[contains(@text,'Sign Up') or @content-desc='com.dometicapp:id/login-signUpText']";
        public static final String Login_forgot_password_link_Xpath_OR_Operator="//android.widget.TextView[contains(@text,'Forgot password?') or @content-desc='com.dometicapp:id/login-forgotText']";
        public static final String Login_Dont_have_an_account_Xpath_OR_Operator="//android.widget.TextView[contains(@text,'Don't have an account?') or @content-desc='com.dometicapp:id/login-noAccountText']";
