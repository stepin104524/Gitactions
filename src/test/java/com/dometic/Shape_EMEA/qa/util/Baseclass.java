...
public class Baseclass {
    ...
    public static String ReportLocation = System.getProperty("user.dir") + "/target/cucumber-reports/advanced-reports/Extentreport_Shape_EMEA/";
    ...
    public void asserttextValidationAccessibility(String arg1, String arg2) throws Throwable {
        ...
        if (actualString.equalsIgnoreCase(arg1)) {
            ...
            System.out.println("Actual text is=" + actualString + " Expected text is=" + arg1 + " Both text are mismatching");
        }
    }
