...
public class Hooks extends Baseclass {
    ...
    public Properties loadProperties() throws IOException {
        prop = new Properties();
        FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "/src/test/resources_Shape_EMEA/globalData.properties");
        prop.load(fis);
        return prop;
    }
...
//        System.out.print(PortNumber);
        ...
        cap.setCapability("app", System.getProperty("user.dir") + "/src/test/java/com/dometic/Shape_EMEA/application/Interact_1.7.5_v18.apk");
        String fullReset = prop.getProperty("fullReset_MTC");
        cap.setCapability("fullReset", fullReset);
        try {
            Android_driver = new AndroidDriver(new URL("http://127.0.0.1:4725/wd/hub"), cap);
...
//        cap.setCapability(MobileCapabilityType.AUTOMATION_NAME, automationName);
        ...
        cap.setCapability("appActivity", appActivity);
        cap.setCapability("app", System.getProperty("user.dir") + "/src/test/java/com/dometic/Shape_EMEA/application/Interact-1.4-v85.apk");
