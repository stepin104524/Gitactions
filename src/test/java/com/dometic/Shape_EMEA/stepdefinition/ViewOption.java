...
import com.dometic.Shape_EMEA.qa.Pages.ConstantViewOption;
import com.dometic.Shape_EMEA.qa.Pages.Constant_settings;
...
public class ViewOption extends Baseclass {
    ...
    public void iTapOnLogout() throws ClassNotFoundException {
        ...
        System.out.println("Tapped on Logout Label");
    }
}
