...
public class SpanishLanguage extends Baseclass {
    ...
    public void iVerifyForgotYourPasswordContentSpanishTextIsDisplayedInForgotPasswordPage() throws Throwable {
        ...
        asserttextValidationAccessibility(Constant_Spanish_Language.ForgetPassword_forgot_enterEmail_Spanish_text_expected, Constant_forgotpassword.ForgetPassword_forgot_enterEmail_access_id);
    ...
    public void emailFieldIsRequiredSpanishTextErrorMessageIsDisplayed() throws Throwable {
        ...
        if(elementsByAccessibilityId.size()!=0){
            asserttextValidation(Constant_Spanish_Language.Signup_invalidemail_Spanish_message_expected,signup_obj.Signup_invalidemail_message_access_id);
        }
    }
    ...
    public void iVerifyLogInTextSpanishIsDisplayedInLoginScreen() throws Throwable {
        ...
        asserttextValidation(Constant_Spanish_Language.Login_login_Spanishtext_expected,Constant_login.Login_login_text_access_id);
    }
    ...
    public void iVerifyDonTHaveAnAccountTextSpanishIsDisplayedInLoginPage() throws Throwable {
        ...
        asserttextValidation(Constant_Spanish_Language.Login_Dont_have_an_account_Spanish_text_expected,Constant_login.Login_Dont_have_an_account_access_id);
    }
