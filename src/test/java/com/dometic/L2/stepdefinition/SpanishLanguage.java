...
public class SpanishLanguage extends Baseclass {
    ...
    public void iVerifyForgotYourPasswordSpanishTextIsDisplayedInForgotPasswordPage() throws Throwable {
        ...
        asserttext(Constant_Spanish_Language.ForgetPassword_forgot_header_Spanish_text_expected,Constant_forgotpassword.ForgetPassword_page_title_xpath_OR_operator);
    }
    ...
    public void iVerifyForgotYourPasswordContentSpanishTextIsDisplayedInForgotPasswordPage() throws Throwable {
        ...
        asserttext(Constant_Spanish_Language.ForgetPassword_forgot_enterEmail_Spanish_text_expected, com.dometic.L1.qa.Pages.Constant_forgotpassword.ForgetPassword_forgot_enterEmail_access_id);
        asserttext(Constant_Spanish_Language.ForgetPassword_forgot_createPass_Spanish_text_expected, Constant_forgotpassword.ForgetPassword_forgot_createPass_xpath_OR_operator);
        asserttext(Constant_Spanish_Language.ForgetPassword_forgot_emailReceive_Spanish_expected, Constant_forgotpassword.ForgetPassword_forgot_emailReceive_xpath_OR_operator);
        asserttext(Constant_Spanish_Language.ForgetPassword_forgot_checkSpam_Spanish_expected, Constant_forgotpassword.ForgetPassword_forgot_checkSpam_xpath_OR_operator);
        asserttext(Constant_Spanish_Language.ForgetPassword_forgot_checkInbox_Spanish_expected, Constant_forgotpassword.ForgetPassword_forgot_checkInbox_xpath_OR_operator);
        asserttext(Constant_Spanish_Language.ForgetPassword_forgot_checkinMin_Spanish_expected, Constant_forgotpassword.ForgetPassword_forgot_checkinMin_xpath_OR_operator);
    }
    ...
    public void iVerifyEMailSpanishLabelIsDisplayed() throws Throwable {
        ...
        asserttext(Constant_Spanish_Language.ForgetPassword_forgot_email_label_Spanish_expected, Constant_forgotpassword.ForgetPassword_forgot_email_label_xpath_OR_operator);
    }
