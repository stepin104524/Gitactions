...
public class Signup extends Baseclass{
    ...
    public void Signup_Page_EmailInputbox() throws Throwable
    {
       ...
       // TaponbuttonaccessabilityID(signup_obj.Signup_login_link_access_id);
        ...
        System.out.println("Email Inputbox is displayed");
    }
    ...
    public void Signup_Page_Password_Inputbox() throws Throwable
    {
        ...
        System.out.println("Password Inputbox is displayed");
    }
    ...
    public void Signup_Page_confirm_password_Inputbox() throws Throwable
    {
        ...
        System.out.println("Confirm Password Inputbox is displayed");
    }
    ...
    public void iTapOnExistingUserPopup() throws InterruptedException {
        ...
        if(elements.size()!=0){
            Thread.sleep(2000);
           // TaponbuttonaccessabilityID(signup_obj.Signup_OK_access_id);
    ...
    public void iVerifyIfCreateYourAccountTextIsDisplayedInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify if Create your account text is displayed in Signup page");
    ...
    public void iVerifyEmailTextInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify Email text in Signup page");
        asserttext(Constant_signup.Email_text,Constant_signup.Email_text_xpath_OR_operator);
        System.out.println("Email text in Signup page verified");
    }

    @Then("I verify Password text in in Signup page")
    public void iVerifyPasswordTextInInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify Password text in in Signup page");
        asserttext(Constant_signup.Password_text,Constant_signup.Password_text_xpath_OR_operator);
        System.out.println("Password text in Signup page verified");
    }

    @Then("I verify Verify password text in Signup page")
    public void iVerifyVerifyPasswordTextInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify Verify password text in Signup page");
        asserttext(Constant_signup.Verify_Password_text,Constant_signup.Verify_Password_text_xpath_OR_operator);
        System.out.println("Verify password text in Signup page verified");
    }

    @Then("I verify I agree to text in Signup page")
    public void iVerifyIAgreeToTextInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify I agree to text in Signup page");
        asserttext(Constant_signup.Agree_To_text,Constant_signup.Agree_To_text_xpath_OR_operator);
        System.out.println("I agree to text in Signup page verified");
    }

    @Then("I verify Dometics Terms and condition text in Signup page")
    public void iVerifyDometicsTermsAndConditionTextInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify Dometics Terms and condition text in Signup page");
        asserttext(Constant_signup.Dometic_Terms_text,Constant_signup.Dometic_Terms_text_xpath_OR_operator);
        System.out.println("Dometics Terms and condition text in Signup page verified");
    }

    @Then("I verify Marketing text in Signup page")
    public void iVerifyMarketingTextInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify Marketing text in Signup page");
        asserttext(Constant_signup.Marketing_text,Constant_signup.Marketing_text_xpath_OR_operator);
        System.out.println("Marketing text in Signup page verified");
    }
    ...
    public void iVerifyMoreInformationTextIsDisplayedInSignupPage() throws Throwable {
        ...
        System.out.println("more information text in Signup page verified");
    }

    @Then("I verify Already have an account text in Signup page")
    public void iVerifyAlreadyHaveAnAccountTextInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify Already have an account text in Signup page");
        asserttext(Constant_signup.Already_have_an_account_text,Constant_signup.Already_have_an_account_text_xpath_OR_operator);
        System.out.println("Already have an account text in Signup page verified");
    }

    @Then("I verify Login text in Signup page")
    public void iVerifyLoginTextInSignupPage() throws Throwable {
        ScenarioDef.createNode(new GherkinKeyword("Then"), "I verify Login text in Signup page");
        asserttext(Constant_signup.Login_text,Constant_signup.Login_text_xpath_OR_operator);
        System.out.println("Login text in Signup page verified");
    }
}
