...
//        System.out.print(PortNumber);
        ...
        cap.setCapability("app", System.getProperty("user.dir") + "/src/test/java/com/dometic/L2/application/AMTH_Interact_1.7.4_2.apk");
...
//        cap.setCapability(MobileCapabilityType.AUTOMATION_NAME, automationName);
        ...
        cap.setCapability("appActivity", appActivity);
        cap.setCapability("app", System.getProperty("user.dir") + "/src/test/java/com/dometic/L2/application/app-release_188.apk");
