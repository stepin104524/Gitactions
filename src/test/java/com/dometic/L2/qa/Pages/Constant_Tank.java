...
public class Constant_Tank {
    ...
    public static final String Tanksscreen_Fresh_xpath="//*[@text='Fresh Water']";
    ...
    public static final String Tankscreen_Tanks_FillingText_xpath="//*[@text='Filling (%)']";
    ...
    public static final String Tank_freshwater_button_fresh="Fresh Water";
    ...
    public static final String Tankscreen_Tanks_FillingText="Filling (%)";
}
