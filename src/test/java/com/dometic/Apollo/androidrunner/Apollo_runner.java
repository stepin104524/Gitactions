...
@CucumberOptions(
        features = "src/test/java/com/dometic/Apollo/features/",
        glue = {"com.dometic.Apollo.stepdefinition"},
        tags = {"@First,@sanity"},
...
@Listeners({com.dometic.Apollo.androidrunner.NGTestListener.class})
public class Apollo_runner {
