...
//        System.out.print(PortNumber);
        ...
        String deviceVersion = prop.getProperty("deviceVersio");
        ...
        cap.setCapability("app", System.getProperty("user.dir") + "/src/test/java/com/dometic/SDB/application/AMTH_Interact_1.7.4_2.apk");
